...
(function(window){
    ...
    function isParent(tar,pClass){
        while(tar.parentNode.className){
            if(tar.parentNode.className.indexOf(pClass) > -1){
                return true;
            }
            tar = tar.parentNode
        }
    ...
    touchSlider.prototype={
        ...
        _touchend: function(e){
            ...
            if(num){
                if(this.totalDist < -op.preDistance && !isParent(e.target,op.scrollClass)){
                    this._scrollNum++  // 1 2
