XIAOMI.namespace("app.slide"), XIAOMI.app.slide = function(t) {
    ...
    function e(t) {
        var e, i, o = this, s = $(t.slideObj), a = s.find(".xm-slide-scroll"), r = s.find("figure"), d = r.length, l = s.width(), f = l * d, u = t.position;
        ...
        if (a.css("width", f).on(n(), function() {
            ...
            "continue" === t.edgeType && n.length > 0 && (u = Number(n.data("source")), o.transform(a, l * u),
            n.css({
                "z-index":"-1"
            }), setTimeout(function() {
            ...
            var i;
            if (void 0 !== n) i = l * u - n; else if (o.runType[t.edgeType](), a.addClass("transition"),
            i = l * u, r.off("touchstart").off("touchend"), s.off("touchmove"), v && v.length > 0) {
            ...
            rollback:function() {
                ...
                0 >= u ? (u = 0, s.find(".xm-slide-leftbutton").addClass("hide"), s.find(".xm-slide-rightbutton").removeClass("hide")) :u >= d - 1 ? (u = d - 1,
                s.find(".xm-slide-rightbutton").addClass("hide"), s.find(".xm-slide-leftbutton").removeClass("hide")) :(s.find(".xm-slide-leftbutton").removeClass("hide"),
                s.find(".xm-slide-rightbutton").removeClass("hide"));
            },
            "continue":function() {
                g.css({
                    "z-index":"1"
                    ...
                    "z-index":"1"
                }), 0 > u ? (g.data("source", d - 1), o.toRun(l * u, d - 1)) :u > d - 1 && (b.data("source", 0),
                o.toRun(-l * u, 0));
            }
